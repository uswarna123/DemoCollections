...
public class DemoArrayList {
    ...
    public static void AddElementsToArrayList(Integer index,String string)
    {
    ...
    public static void main(String[] args) {
        ...
        DemoArrayList.AddElementsToArrayList(0,"black");
        System.out.println(arrayList);
        DemoArrayList.AddElementsToArrayList(0,"pink");
        System.out.println(arrayList);
